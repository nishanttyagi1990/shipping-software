...
import AllOrder from "./RevieveInventory";
...
export default function ReceiveInventoryParent(props) {
...
const getShipmentIdFromShipment=(shipmentId)=>{
    ...
    <View className={classes.content}>
      ...
      <View style={popUpStyle.paddingSide}>
        ...
        <AppBar position="static" color="default" style={{ marginTop: "15px" }}>
          ...
          >
           <Tab label={<span className={classes.tabRoot}>All Shipment</span>} {...a11yProps(0)} />
             <Tab label={<span className={classes.tabRoot}>New Shipment</span>} {...a11yProps(1)} />
            <Tab label={<span className={classes.tabRoot}>Processed</span>} {...a11yProps(2)} />
            <Tab label={<span className={classes.tabRoot}>Shipped</span>} {...a11yProps(3)} />
            <Tab label={<span className={classes.tabRoot}>Arrived</span>} {...a11yProps(4)} />
          </Tabs>
        </AppBar>
        <TabPanel value={value} index={0}>
          <AllOrder
            ...
            orderStatus={0}
            getShipmentIdFromShipment={getShipmentIdFromShipment}
...
ReceiveInventoryParent.propTypes = {
