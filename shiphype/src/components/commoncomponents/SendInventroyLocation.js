...
export default function ManualOrder(props) {
   ...
   const classes = useStyles();  
    const handleChangeButton = (id) => {
      props.invenotyLocationUpdate(id);
...
React.useEffect(() => {
    ...
    <View className={classes.appBarSpacer} />
          ...
          <Text style={popUpStyle.breadCrundCss2}>/ Select Shipper {'\n'} </Text> 
        ...
        <Text style={{ fontSize: '15px',
          fontWeight: '700',
            ...
            transition : 'all 0.25s',}}>
              ...
              Are the items being shipped from your location or directly from your distributor?</Text>
              </Grid>
              </Grid>
