...
export default function Main(props) {
  ...
  const [position, setPosition] = React.useState(
    props.navigation.getParam("position", "0")
  );
  ...
  const [code, setCode] = React.useState(
    props.navigation.getParam("code", "0")
  );
  const [expiredate, setExpireDate] = React.useState(
    props.navigation.getParam("expiredate", "0")
  );
  const [token, setToken] = React.useState("");

  const [
    fromWarehouseIdInventory,
    setFromWarehouseIdInventory,
  ] = React.useState(0);
  ...
  const [uuserdid, setUUId] = React.useState(
    parseInt(window.localStorage.userid)
  );
  ...
  const [openCustomePromotional, setOpenCustomePromotional] = React.useState(
    false
  );
  ...
  const [
    openCreateCustomeIntegration,
    setOpenCreateCustomeIntegration,
  ...
  const [openAddCustomerManually, setOpenAddCustomerManually] = React.useState(
    false
  );
  ...
  const [importDataShopifyData, setImportDataShopifyData] = React.useState(
    null
  );
  const [importDataShopifyData1, setImportDataShopifyData1] = React.useState(
    null
  );
  const [importDataShopifyDataId, setImportDataShopifyDataId] = React.useState(
    0
  );
   ...
   */
  useEffect(() => {
   console.log("MaincallwhenpushOrder");
  ...
  const showToast = (open, msg, type) => {
    ...
    return (
      <Toast open={toast} handleClose={handleClose} type={type} msg={msg} />
    );
  };
  ...
  const handleSideNext = (isSprintCreate) => {
    ...
    if (isSprintCreate === "02") {
      ...
      if (position === isSprintCreate) {
        ...
        props.navigation.push("ReceiveOrderCanada", {
      ...
      if (position === isSprintCreate) {
        ...
        props.navigation.push("ReceiveReturnOrder", {
          position: isSprintCreate,
        });
        //setPosition(isSprintCreate);
      }
      ...
      if (position === isSprintCreate) {
        ...
        props.navigation.push("MarketPlaceSetting", {
          position: isSprintCreate,
        });
      }
      ...
      if (position === isSprintCreate) {
        ...
        props.navigation.push("TransactionHistory", {
          position: isSprintCreate,
        });
      }
    ...
    // }
      ...
      if (position === isSprintCreate) {
        ...
        props.navigation.push("MarketPlaceIntegration", {
          position: isSprintCreate,
        });
      }
  ...
  const updateSelectCustomeArray = (
    PackageId,
    PackageTypeId,
    packagingquant
  ) => {
  ...
  const updateSelectPromotionalArray = (
    PackageId,
    PackageTypeId,
    packagingquant
  ) => {
  ...
  const SwitchHandling = () => {
    if (position === 0) {
      ...
      return (
        <SelectedReturnOrderDetailsSeller
          backButtonRouting={backButtonRouting}
          internalorder_id={internalorderid}
          isAdmin={isAdmin}
          user_id={userid}
  ...
  const handletopImiate = () => {
    ...
    AsyncStorage.setItem("userid", JSON.stringify(1));

    localStorage.storeData("imitate", false);

    window.sessionStorage.setItem("imitate", false);
    AsyncStorage.setItem("imitate", JSON.stringify(false));
  ...
  return (
    <View className={classes.root}>
      ...
      >
        <Toolbar className={classes.toolbar}>
          ...
          {(() => {
            if (isAdmin === true) {
              return (
                ...
                >
                  <Text
                    style={[popUpStyle.creditTitle, { textAlign: "center" }]}
                  >
                    CREDIT{" "}
                  </Text>
                ...
                >
                  ...
                  >
                    <View style={{ width: 150 }}>
                      ...
                      >
                        <Text style={popUpStyle.creditmenutitle}>
                          Available{" "}
                        </Text>

                        {currentavaliableamount ? (
                          <Text style={popUpStyle.creditmenutitle}>
                            ${currentavaliableamount} USD{" "}
                          </Text>
                        ) : (
                          <Text style={popUpStyle.creditmenutitle}>
                            $0.00 USD{" "}
           ...
           */}
                    ...
                    {isAdmin === true ? (
                      <Text
                        className={classes.dropDownIconHover}
                        onClick={() => {
                          billingSettingOpen1(popupState);
                        }}
                      >
                        <BootstrapButton
                          onClick={() => {
                    ...
                    {isAdmin === true ? (
                      <Text
                        className={classes.dropDownIconHover}
                        onClick={() => {
                          billingSettingOpeninvoice(popupState);
                        }}
                      >
                        <BootstrapButton
                          onClick={() => {
                    ...
                    <Text
                      className={classes.dropDownIconHover}
                      onClick={() => {
                        handleSideeNext("015", popupState);
                      }}
                    >
                      <BootstrapButton
                        onClick={() => {
                    ...
                    {isAdmin === true ? (
                      ...
                      >
                        <BootstrapButton
                          ...
                          startIcon={
                            <FeedbackIcon style={popUpStyle.iconHeight} />
                          }
                        >
                          Feedback
                        </BootstrapButton>
      ...
      <View style={{ flex: 1, flexDirection: "row" }}>
        <View
          className={clsx(!open && drawerWidthClosed, open && drawerWidthOpen)}
        >
          <Drawer
            variant="permanent"
            classes={{
                  ...
                  {(() => {
                    if (open === true) {
                      return (
                        <Text
                          className={clsx(
                            !open && classes.toolbarIconClose1,
                            open && classes.toolbarIconOpen1
                          )}
                        >
                          DASHBOARD
                        </Text>
                      ...
                      return <hr style={popUpStyle.hrStyle} />;
                    }
                  })()}
                                  ...
                                  {(() => {
                                    if (data.moduleid === "01") {
                                      ...
                                      if (position === "02") {
                                        ...
                                        position ===
                                        "selected_order_detailsforSellerData"
                                      ) {
                                        return (
                                          <AddShoppingCartOutlinedIcon
                                            style={popUpStyle.drawerIcon}
                                        ...
                                        position === "additional_order_options"
                                      ) {
                                        return (
                                          <AddShoppingCartOutlinedIcon
                                            style={popUpStyle.drawerIcon}
                                        ...
                                        position === "orderSelectPromotional"
                                      ) {
                                        return (
                                          <AddShoppingCartOutlinedIcon
                                            style={popUpStyle.drawerIcon}
                                        ...
                                        position === "importOrderfetchShopify"
                                      ) {
                                        return (
                                          <AddShoppingCartOutlinedIcon
                                            style={popUpStyle.drawerIcon}
                                      ...
                                      if (position === "14") {
                                        ...
                                        position === "selected_order_details"
                                      ) {
                                        return (
                                          <LibraryAddCheckIcon
                                            style={popUpStyle.drawerIcon}
                                      ...
                                      if (position === "15") {
                                        ...
                                        position === "SelectCarrierTrackingDate"
                                      ) {
                                        return (
                                          <LibraryAddCheckIcon
                                            style={popUpStyle.drawerIcon}
                                  ...
                                  {(() => {
                                    if (data.moduleid === "05") {
                                      ...
                                      if (position === "08") {
                                        ...
                                        position === "selectCustomSubcription"
                                      ) {
                                        return (
                                          <SubscriptionsIcon
                                            style={popUpStyle.drawerIcon}
                                      ...
                                      if (position === "09") {
                                        ...
                                        position === "sendInventoryPromotional"
                                      ) {
                                        return (
                                          <HomeWorkIcon
                                            style={popUpStyle.drawerIcon}
                                        ...
                                        position === "SendIneventoryShipping"
                                      ) {
                                        return (
                                          <HomeWorkIcon
                                            style={popUpStyle.drawerIcon}
                                        ...
                                        position === "SendInventoryPackingType"
                                      ) {
                                        return (
                                          <HomeWorkIcon
                                            style={popUpStyle.drawerIcon}
                                        ...
                                        position === "SendInventroyLocation"
                                      ) {
                                        return (
                                          <HomeWorkIcon
                                            style={popUpStyle.drawerIcon}
                                      ...
                                      if (position === "11") {
                                        ...
                                        position === "select_transfer_inventory"
                                      ) {
                                        return (
                                          <SwapHorizIcon
                                            style={popUpStyle.drawerIcon}
                ...
                if (open === true) {
                  return (
                    ...
                    >
                      <Grid
                        container
                        style={{ padding: "5%", height: "50%", width: "100%" }}
                      >
                        <Grid items lg={1} xs={12}></Grid>
                        <Grid items lg={2} xs={12}>
                          <FlashOnIcon style={{ color: "#fff" }} />
                        </Grid>
      ...
      <Grid>
        ...
        >
          <Alert onClose={handleClose3} severity="success">
            You are all set up now. Please click the "Send Inventory" tab to
            start sending inventory to ShipHype!
          </Alert>
        </Snackbar>
        ...
        >
          <Alert onClose={handleClose6} severity="error">
            You have break the process in between of send inventory, Data will
            be lost.
          </Alert>
        </Snackbar>
