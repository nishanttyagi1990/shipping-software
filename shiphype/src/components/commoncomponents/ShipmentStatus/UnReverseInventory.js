...
export default function ShippingProfile(props) {
   ...
   const {openUnReverseInventory}= props;
  ...
  const handleClose1 = () => {
    ...
    Order is shipped, Do you want to change the order status to shipped?
       </Text>
       {/* <Text style={{fontSize: '12px',
           // fontWeight: '700',
            ...
            marginBottom:'20px',
            fontFamily: '-apple-system, BlinkMacSystemFont, "Inter UI", Roboto, sans-serif',}}>
     This will stop inventory from being reserved for this order so you can fulfill other orders with the previously reserved stock. However when this order is ready to ship you may not have the inventory to fulfill this order  </Text>
          */}
          </Grid>
      ...
      No
        ...
        <ColorButton
          ...
          color='primary'
          className={classes.submit}
          onClick={props.handleConfirmDone}
        >
    Order shipped
        </ColorButton>
        </Grid>
  ...
  ShippingProfile.propTypes = {
    openUnReverseInventory: PropTypes.bool,
