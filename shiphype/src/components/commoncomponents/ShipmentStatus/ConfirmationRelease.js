  ...
  const handleClose1 = () => {
    ...
    return (  
      ...
      container>
       ...
       Are you sure you want to release the hold on the order(s)? 
       </Text>
       <Text style={{fontSize: '12px',
           // fontWeight: '700',
            ...
            marginBottom:'20px',
            fontFamily: '-apple-system, BlinkMacSystemFont, "Inter UI", Roboto, sans-serif',}}>
       This will immediately release any manual holds on the orders and start the fulfillment process if no other holds exist. You can undo this by moving the order back to on-hold.
       </Text>
