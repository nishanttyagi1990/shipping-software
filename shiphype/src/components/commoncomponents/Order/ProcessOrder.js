  ...
  const handleClose1 = () => {
    ...
    return (  
      ...
      container>
       ...
       Are you sure you want to Process the order(s)?
       </Text>
       <Text style={{fontSize: '12px',
           // fontWeight: '700',
            ...
            marginBottom:'20px',
            fontFamily: '-apple-system, BlinkMacSystemFont, "Inter UI", Roboto, sans-serif',}}>
     Currently being processed by ShipHype,
      it will get marked as ``Processing” meaning that ShipHype is working on picking or packing the order.
</Text>
