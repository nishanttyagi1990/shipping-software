...
export default function ShippingProfile(props) {
   ...
   const {openCancelOrderSet}= props;
...
const handleChange1 = event => {
 ...
 /**
  ...
  const handleChangeShipped = () => {
    setLoading(true);
    // shiphypeservice.cancelRequestParcel()
    // .then(response => {
      ...
      Are you sure you want to change the order status?
       ...
       <Text style={{fontSize: '12px',
           // fontWeight: '700',
            ...
            marginBottom:'10px',
            fontFamily: '-apple-system, BlinkMacSystemFont, "Inter UI", Roboto, sans-serif',}}>
    Add Reason For Cancel Order. </Text>
       <Grid item xs={10} >
  ...
  ShippingProfile.propTypes = {
    openCancelOrderSet: PropTypes.bool,
