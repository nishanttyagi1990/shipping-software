      ...
      },
      {
        ...
        render: (rowData) => (
          <View>
            {(() => {
              if (
                rowData.shippinglabel === 0 ||
                rowData.shippinglabel === null
              ) {
                return <Text style={{
                            fontSize: "11px",
                            fontFamily:
      ...
      },
      {
        ...
        render: (rowData) => (
          <View>
            {(() => {
              if (
                rowData.packaginslipdocnameid === 0 ||
                rowData.packaginslipdocnameid === null
              ) {
                return <Text style={{
                            fontSize: "11px",
                            fontFamily:
      ...
      },
      {
        ...
        render: (rowData) => (
          <View>
            {(() => {
              if (
                rowData.invoicetypedocnameid === 0 ||
                rowData.invoicetypedocnameid === null
              ) {
                return <Text style={{
                            fontSize: "11px",
                            fontFamily:
      ...
      <View>
        <Grid item container lg={12}>
          <Grid item lg={5} style={{ marginTop: "5px" }}>
            ...
            <Text style={popUpStyle.breadCrundCss}> ORDERS /</Text>
