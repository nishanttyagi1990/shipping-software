...
<Text style={{ fontSize: '11px', 
 ...
 const fetchCustomePackageingList = ()=>{
  ...
  //  const userid=5;
    setLoading(true);
    shiphypeservice.fetchCustomePaching(uuserdid,2)
    .then(response => {
  ...
  const fetchArrangeShip = (shipmentId)=>{
    ...
    //       if(response.status === true) {
    //            setLoading(false);
               if(props.editOrder.promotionalinserts !== 0){
                setCheckedA(false);
                if(props.editOrder.promotionalinserts !== 0){
                for(let i=0;i<props.editOrder.promotionalinserts.length;i++){
                ids.push(props.editOrder.promotionalinserts[i].promotionalinsertId);
                }
...
<Text style={{ fontSize: '11px', 
   ...
   <Text style={{ fontSize: '11px', 
    ...
    const onNextfunction=()=>{
        ...
        props.handleNextPage('selectCustomSubcription');
    }
    var flag =false;
...
<Text style={{ fontSize: '11px', 
   ...
   <Text style={{ fontSize: '11px', 
      ...
      const handleCallbackfunction =()=>{
        props.backButtonRouting('selectProductForSubscription');
      }
  const handleClose = () => {
    setOpen(false);
  };
...
<View >
          ...
          <Text style={popUpStyle.breadCrundCss2}> PROMOTIONAL INSERTS {'\n'} </Text> 
...
transition : 'all 0.25s',}}>
  ...
  Select which Promotional Inserts you would like to add to this Subscription Box</Text>
  </Grid> */}
...
Next
        ...
        title={<Text style={{ fontSize: '13px',
            ...
            color: '#001737',
            marginLeft:'5px',
            transition : 'all 0.25s',}}>Select which Promotional Inserts you would like to add to this Subscription Box</Text> }
