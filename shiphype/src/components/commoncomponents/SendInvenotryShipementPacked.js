...
export default function ManualOrder(props) {
   ...
   const classes = useStyles();  
    const handleChangeButton = (id) => {
      props.invenotyShipemntTypeUpdate(id);
        props.handleNextPage('SendIneventoryShipping');
...
React.useEffect(() => {
    ...
    <View className={classes.appBarSpacer} />
          ...
          <Text style={popUpStyle.breadCrundCss2}>/ Shipment Packing {'\n'} </Text> 
        ...
        <Text style={{ fontSize: '15px',
          fontWeight: '700',
            ...
            transition : 'all 0.25s',}}>
              ...
              How is your shipment packaged?</Text>
              </Grid>
              </Grid>
