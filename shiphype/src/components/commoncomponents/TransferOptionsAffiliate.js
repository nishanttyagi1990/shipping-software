    ...
    return (
      <MuiDialogTitle disableTypography className={classes.root} {...other}>
        ...
        <Typography justify="center" variant="body1" style={{fontSize: '16px',
            ...
            marginTop:'20px',
            marginBottom:'20px',
            fontFamily: '-apple-system, BlinkMacSystemFont, "Inter UI", Roboto, sans-serif',}}>Transfer Credit
            </Typography>
            </Grid>
      </MuiDialogTitle>
    );
 ...
 * @param {*} props 
 */
export default function TransferOptionsAffiliate(props) {
 ...
 /**
  ...
  const handleChangeShipped = () => {
    ...
    <TextField
      ...
      variant="outlined"
      fullWidth
      error={hasError('TransferTo')}
      helperText={
         hasError('TransferTo') ? formState.errors.TransferTo[0] : null
      }
      ...
      value={formState.values.TransferTo || ''}
    />
  ...
  TransferOptionsAffiliate.propTypes = {
    transfercredit: PropTypes.bool,
