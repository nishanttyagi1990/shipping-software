...
export default function CreateSprint(props) {
  ...
  const [state, setState] = React.useState({
    columns: [
      ...
      { title: "Order ID", field: "id", type: "text",
...
<Text style={{ fontSize: '11px', 
    ...
    />  
      ...
      { title: "Source Name", field: "source_name", type: "text",
      render: rowData =><FormControlLabel
...
<Text style={{ fontSize: '11px', 
    fontFamily: '-apple-system, BlinkMacSystemFont, "Inter UI", Roboto, sans-serif',
    transition : 'all 0.25s',}}>{rowData.source_name}</Text>
...
<Text style={{ fontSize: '11px', 
    fontFamily: '-apple-system, BlinkMacSystemFont, "Inter UI", Roboto, sans-serif',
    transition : 'all 0.25s',}}>{rowData.name}</Text>
...
<Text style={{ fontSize: '11px', 
    fontFamily: '-apple-system, BlinkMacSystemFont, "Inter UI", Roboto, sans-serif',
    transition : 'all 0.25s',}}>{rowData.customer.id}</Text>
...
<Text style={{ fontSize: '11px', 
    ...
    />  },
      { title: "Customer ID", field: "customer_id", type: "text",
      render: rowData =><FormControlLabel
...
<Text style={{ fontSize: '11px', 
    fontFamily: '-apple-system, BlinkMacSystemFont, "Inter UI", Roboto, sans-serif',
    transition : 'all 0.25s',}}>{rowData.customer_id}</Text>
          
        </Typography>}
    />  
    },

      { title: "Order Status", field: "status", type: "text",
      render: rowData =><FormControlLabel
...
<Text style={{ fontSize: '11px', 
    ...
    />  
      ...
      { title: "Date Created", field: "date_created", type: "text",
...
<Text style={{ fontSize: '11px', 
    fontFamily: '-apple-system, BlinkMacSystemFont, "Inter UI", Roboto, sans-serif',
    transition : 'all 0.25s',}}>{rowData.date_created}</Text>
...
<Text style={{ fontSize: '11px', 
  ...
  const deleteIntegrationOrder = (externalorder_id)=>{
    setLoading(true);
    shiphypeservice.deleteIntegrationOrder(externalorder_id)
    .then(response => {
     console.log("status",response.status);
          if(response.status === true) {
            setOpen(true);
