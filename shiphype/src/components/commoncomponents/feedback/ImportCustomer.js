...
import ImportShopfyCustomer from "./ImportShopfyCustomer";
  ...
  return (
    <MuiDialogTitle disableTypography className={classes.root} {...other}>
      ...
      <Grid item xs={12}>
        ...
        >
          {" "}
          Select which integration you would like to Import Customers from:
        </Typography>
      </Grid>
    </MuiDialogTitle>
  );
...
export default function CreateSprint(props) {
  ...
  const { openSelectCustomer } = props;
  ...
  const [openshopfy1, setOpenshopfy] = React.useState(false);
        ...
        <Typography justify="center" variant="body1" style={{fontSize: '14px',
          ...
          <Grid>
            ...
            {openshopfy1 === false ? (
              ...
              <ImportShopfyCustomer
                openshopfy1={openshopfy1}
                userid={userid}
...
CreateSprint.propTypes = {
  openSelectCustomer: PropTypes.bool,
