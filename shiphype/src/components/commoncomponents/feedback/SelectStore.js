...
import ImportShopfyProduct from "./ImportShopfyProduct";
  ...
  return (
    <MuiDialogTitle disableTypography className={classes.root} {...other}>
      ...
      <Grid item xs={12}>
        ...
        >
          {" "}
          Select which integration you would like to Import Products from:
        </Typography>
      </Grid>
    </MuiDialogTitle>
  );
...
CreateSprint.propTypes = {
  openSelectStore: PropTypes.bool,
